...
<body>
    ...
    <footer>
        <p>Designed and Developed by NANDHITHA S<p>
    </footer>
</body>
</html>
```
...
<body>
    ...
    <div class="menu-container">
        <div class="menu-item">
            <img src="bir.png" alt="Dish 1">
            <h3>BIRYANI</h3>
            <p>The MOST Authentic Chennai Biryani</p>
            <div class="price">SGD 2.70</div>
        </div>
        <div class="menu-item">
            <img src="fri.png" alt="Dish 2">
            <h3>CHICKEN FRIED RICE</h3>
            <p>THE SIGNATUE DISH OF OUR RESTUARANT</p>
            <div class="price">SGD 3.30</div>
        </div>
        <div class="menu-item">
            <img src="par.png" alt="Dish 3">
            <h3>PAROTTA</h3>
            <p>Two Piece Of The Flakiest, Softest Parotta</p>
...
<body>
    ...
    <div class="staff-container">
        <div class="staff-item">
            <img src="q1.png" alt="KARAN">
            <h3>KARAN</h3>
            <p>KARAN is responsible for the overall success of the cafe. Think finances, legalities, marketing, and building a team.</p>
            <div class="position">Cafe Owner</div>
        </div>
        <div class="staff-item">
            <img src="q2.png" alt="ZAARA">
            <h3>ZAARA</h3>
            <p> ZAARA oversees all aspects of a café's operations. This includes: selling food and drinks, hiring and scheduling staff, menu planning, and maintaining inventory. </p>
            <div class="position">Manager</div>
        </div>
        <div class="staff-item">
            <img src="q5.png" alt="Aarti Lucica Sequeira">
        ...
        <div class="staff-item">
            <img src="q3.png" alt="Vikas Khanna">
            <h3>Vikas Khanna</h3>
        ...
        <div class="staff-item">
            <img src="q6.png" alt="Saransh Goila">
            <h3>Saransh Goila</h3>
...
```
## OUTPUT:
![alt text](<Screenshot 2025-05-03 131151.png>)

![alt text](<Screenshot 2025-05-03 131214.png>)

![alt text](<Screenshot 2025-05-03 131229.png>)

![alt text](<Screenshot 2025-05-03 131248.png>)

![alt text](<Screenshot 2025-05-03 131327.png>)
## RESULT:
